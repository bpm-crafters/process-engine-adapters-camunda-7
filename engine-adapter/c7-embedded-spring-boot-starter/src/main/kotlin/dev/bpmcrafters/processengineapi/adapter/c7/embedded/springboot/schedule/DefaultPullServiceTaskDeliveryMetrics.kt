...
import dev.bpmcrafters.processengineapi.adapter.c7.embedded.task.delivery.pull.EmbeddedPullServiceTaskDeliveryMetrics.DropReason
import dev.bpmcrafters.processengineapi.adapter.c7.embedded.task.delivery.pull.EmbeddedPullServiceTaskDeliveryMetrics.FetchAndLockSkipReason
...
class DefaultPullServiceTaskDeliveryMetrics(
  ...
  companion object {
    const val PREFIX = "bpmcrafters.c7.embedded.scheduled.external.tasks"
